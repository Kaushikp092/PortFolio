...
const About = () => {
	...
	return (
		<>
			<InView
				variants={{
					hidden: { opacity: 0, y: 100, filter: "blur(40px)" },
					visible: { opacity: 1, y: 0, filter: "blur(0px)" },
				}}
				viewOptions={{ margin: "0px 0px -130px 0px" }}
			...
			>
				...
				>
					<p style={spacing}>
						I’m a passionate entry-level web developer with a strong foundation
						in <span style={unique}>HTML, CSS </span> and{" "}
						<span style={unique}>JavaScript.</span>
					</p>
					<p style={spacing}>
						Currently focused on building modern, responsive user interfaces
						using <span style={unique}>React.js </span> and{" "}
						<span style={unique}> Tailwind CSS.</span>
					</p>
					<p style={spacing}>
						I enjoy turning ideas into clean, functional designs with attention
						to detail and usability.
					</p>
					<p style={spacing}>
					...
					<p style={spacing}>
						A quick learner, problem solver, and team player who’s eager to grow
